...
class AchievementButton extends SpriteButtonComponent with HasGameRef<BitmanMath>{
  AchievementButton({
  ...
  FutureOr<void> onLoad() {
    button = getSprite(SpriteSheets.coloredTransparent, 562, 256, 14, 14);
    ...
    onPressed =() {
      add(
        RotateEffect.by(2*pi, EffectController(
          ...
          game.router.pushNamed(ScreenStatus.achievement.name);
        },)
      );
    };
    return super.onLoad();
