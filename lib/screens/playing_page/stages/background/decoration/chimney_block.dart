...
with StageBlock implements StageObject,Ridable{
  ...
  FutureOr<void> onLoad() {
    final vNormalSprite = getSprite(SpriteSheets.coloredTransparentPacked, 22*16,16, 16, 16);
    final vJointSprite = getSprite(SpriteSheets.coloredTransparentPacked, 22*16, 32, 16, 16);
    switch(status){
