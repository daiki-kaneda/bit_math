...
import 'package:bit_math/screens/playing_page/stages/actor/attack_component/attack.dart';
...
with StageBlock,CollisionCallbacks implements StageObject,Ridable{
  ...
  FutureOr<void> onLoad() {
    ...
    add(ColorEffect(Colors.black38,EffectController(
      duration: 1.0,
      alternate: true,
      infinite: true
    ),opacityFrom: 0.4,opacityTo: 0.6));
    case BreakableBlockStatus.projectileBreakable:{
      add(ColorEffect(Colors.white, EffectController(
      duration: 1.5,
      alternate: true,
      infinite: true
    ),opacityFrom: 0.6));
    ...
    case BreakableBlockStatus.chain:{
      add(ColorEffect(Colors.grey, EffectController(
      duration: 1.5,
      alternate: true,
      infinite: true
    ),opacityFrom: 0.6));
